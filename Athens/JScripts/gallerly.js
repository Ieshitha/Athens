function yellow(id) {
    ...
    if (id == "one") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Cricket.jpg'/>";
    } else if (id == "three") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Ground.jpg'/>";
    } else if (id == "four") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Gym.jfif'/>";
    } else if (id == "five") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Hockey.jpg'/>";
    } else if (id == "six") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Turf.jpg'/>";
    } else if (id == "seven") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Tennis.jfif'/>";
    } else if (id == "eight") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Swimming.jpg'/>";
    } else if (id == "nine") {
        ...
        document.getElementById("pop_img").innerHTML = "<img src='Images/Cups.jpg'/>";
    }
